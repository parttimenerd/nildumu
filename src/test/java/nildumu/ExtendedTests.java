...
public class ExtendedTests {
    ...
    public void testLowerPowerOfTwo() {
        parse("bit_width 5; h input int h = 0buuuuu; int x = 0; if (2 < h) { x = h; } int y = x").val("y", "0b0uuuu").run();
    }

    @Test
    public void testLowerOnes() {
        parse("bit_width 5; h input int h = 0buuuuu; int x = 0; if (3 < h) { x = h; } int y = x").val("y", "0b0uuuu").run();
    }

    @Test
    public void testLower() {
        parse("bit_width 5; h input int h = 0buuuuu; int x = 0; if (h > 0) { x = h; } int y = x").val("y", "0b0uuuu").run();
    }

    @Test
    public void testLowerCombination() {
        parse("bit_width 7; h input int h = 0buuuuuuu; int x = 0; if ((((4 < h) || (4 == h)) && (h < 16))) { x = h; } int y = x").val("y", "0b000uuuu").run();
    }

    @Test
    public void testLowerCombination2() {
        parse("bit_width 7; h input int h = 0buuuuuuu; int x = 0; if (h < 16) { x = h; } int y = x").val("y", "0buuuuuuu").run();
    }

    @Test
    public void testLowerCombination3() {
        parse("bit_width 7; h input int h = 0buuuuuuu; int x = 0; if ((4 < h) || (4 == h)) { x = h; } int y = x").val("y", "0b0uuuuuu").run();
    }

    @Test
    public void testLowerCombination4() {
        parse("bit_width 4; h input int h = 0buuuu; int x = 0; if ((0 < h) && (h < 4)) { x = h; } int y = x").val("y", "0b00uu").run();
    }

    @Test
    public void testLowerCombination5() {
        parse("bit_width 4; h input int h = 0buuuu; int x = 0; if ((0 < h || h == 0) && (h < 4)) { x = h; } int y = x").val("y", "0b00uu").run();
    }

    @Test
    public void testLowerCombination6() {
        parse("bit_width 7; h input int h = 0buuuuuuu; int x = 0; if ((2 < h) || (2 == h)) { x = h; } int y = x").val("y", "0b0uuuuuu").run();
    }

    @Test
    public void testLowerCombination7() {
        parse("bit_width 8; h input int h = 0bu{8}; int x = 0; if (4 < h && h < 16) { x = h; } int y = x").val("y", "0b0000uuuu").run();
    }

    @Test
    public void testLowerCombination8() {
        parse("bit_width 6; h input int h = 0bu{6}; int x = 0; if (0 < h && h < 2) { x = h; } int y = x").val("y", "0b00000u").run();
    }

    @Test
    public void testShortCircuitPropagation() {
        parse("bit_width 2; h input int x = 0buu; h input int y = 0buu; int z = 0; if (x == 0 && y == x) { z = y; } int a = z").val("a", "0b00").run();
    }

    @Test
    public void testShortCircuitPropagation2() {
        parse("bit_width 2; h input int x = 0buu; h input int y = 0buu; int z = 0; if ((x != 0) && (x != 0 || y == x)) { z = y; } int a = z").val("a", "0buu").run();
    }

    @Test
    public void testShortCircuitPropagation3() {
        parse("bit_width 2; h input int x = 0buu; h input int y = 0b0u; int z = 0; if ((x > 0) || (x == 0 || y == x)) { z = y; } int a = z").val("a", "0b0u").run();
    }
    ...
    public void testModulo() {
        parse("bit_width 3; h input int O = 0b0u{2};\n int z = 3;" +
                "if (O % 2 == 0) {\n" +
                "    O = O + 1; z = O;\n" +
                "}\n" +
