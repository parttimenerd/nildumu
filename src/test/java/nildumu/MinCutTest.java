    ...
    public static class BitGraphs extends Generator<BitGraphWrapper> {
        ...
        public BitGraphWrapper generate(SourceOfRandomness random, GenerationStatus status) {
            ...
            return new BitGraphWrapper(new BitGraph(con, Collections.singletonList(new Value(new ArrayList<>(sinks))),
                    new MethodInvocationHandler.MethodReturnValue(new Value(new ArrayList<>(sources)), new HashMap<>(), new InputBits()), Optional.empty(), new InputBits()), bitNum, depCount, bits);
        }
        ...
        BitGraphWrapper cloneWithout(SourceOfRandomness random, BitGraphWrapper graph, float deletedDepfraction) {
            ...
            return new BitGraphWrapper(new BitGraph(con, Collections.singletonList(new Value(newSinks)),
                    new MethodInvocationHandler.MethodReturnValue(new Value(newSources), new HashMap<>(), new InputBits()), Optional.empty(), new InputBits()),
        ...
        BitGraphWrapper cloneWithoutBit(SourceOfRandomness random, BitGraphWrapper graph, Bit rem) {
            ...
            return new BitGraphWrapper(new BitGraph(con, Collections.singletonList(new Value(newSinks)),
                    new MethodInvocationHandler.MethodReturnValue(new Value(newSources), new HashMap<>(), new InputBits()),
                    Optional.empty(), new InputBits()),
                    bitCount.val, depCount.val, alreadyVisited);
        }
