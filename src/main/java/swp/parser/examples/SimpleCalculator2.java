 ...
 */
public class SimpleCalculator2 implements Serializable {
	...
	public SimpleCalculator2() {
		generator = Generator.getCachedIfPossible("_simplecalculator__22",
				"PLUS = \\+; MINUS = \\-; DIVIDE = /; MULTIPLY = \\*; POW = \\*\\*; " +
						"EQUAL_SIGN = =; EQUALS = ==; UNEQUALS = !=; INVERT = !; LOWER = <; GREATER = >; AND = &&; OR = ||;" +
						"LPAREN = \\(; RPAREN = \\);" +
						"QUESTION_MARK = \\?; COLON = :;" +
						"$digits = [0-9]+; NUMBER = $digits (\\. $digits)?; " +
						"STRING = \"[^\"]*\";" +
